...
<div class="admission" id="setting-content-container">    
    <form action="function/tab_function.php?action=admission" method="post" class="form">
        ...
        <div class="d-sm-flex justify-content-end mt-2">
            ...
            <button class="btn btn-outline-danger" type="button" data-toggle="modal" data-target="#scheduleModal">See Schedule</button>
        </div>
            ...
            <div class="modal-dialog modal-dialog-center" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="scheduleModalTitle">Pre-admission Schedule</h5>
                    ...
                    <div class="modal-footer">
                        <a href="tab/disable.php"><button class="btn btn-outline-secondary" type="button">Disable</button></a>
                        <button class="btn btn-secondary" type="button" data-toggle="modal" data-target="#updateModal" data-dismiss="modal">Update</button>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <form action="function/tab_function.php?action=update_schedule" method="post" class="form">
                                    <div class="row">
                                        ...
                                        <div class="col-12 d-flex justify-content-end">
                                            <button class="btn btn-outline-secondary mr-2" type="button" data-dismiss="modal">Close</button>
                                            <button class="btn btn-secondary" type="submit" name="submit" value="submit">Save</button>
                                        </div>
                                    </div>
                                </form>
                        <?php
